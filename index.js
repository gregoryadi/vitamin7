...
function Home({ countries }) {
  ...
  return (
    <div>
      ...
      {/* Conditionally apply dark-mode styling based on pathname */}
      <main className={clsx(styles.container, { 'dark-mode': pathname === '/dark-mode' })}>
        ...
        {/* Add navigation links for Dark Mode and Light Mode */}
        <div>
          <Link href="/dark-mode" className="button">Dark Mode</Link>
          <Link href="/light-mode" className="button">Light Mode</Link>
        </div>
